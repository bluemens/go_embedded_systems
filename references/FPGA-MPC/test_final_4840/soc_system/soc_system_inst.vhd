	component soc_system is
		port (
			admm_read                    : in    std_logic                     := 'X';             -- read
			admm_readdata                : out   std_logic_vector(31 downto 0);                    -- readdata
	...
	u0 : component soc_system
		port map (
			admm_read                    => CONNECTED_TO_admm_read,                    --     admm.read
			admm_readdata                => CONNECTED_TO_admm_readdata,                --         .readdata
