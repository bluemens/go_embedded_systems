...
The rather fragile \emph{sopc2dts} program does not recognize the
\emph{altera\_pll} component and the clock it generates,
so edit the \emph{clocks} line in the \emph{vga\_tiles} component
\emph{soc\_system.dts} file to remove the reference to \emph{vga\_clk\_pll},
i.e.,
...
One mistake was bad bit numbers in vga_tiles.sv, causing the palette to behave
erratically.
...
When I moved to two clocks, it took a while to understand that it needed two resets, too.
